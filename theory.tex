...
$\theta_0=36^\circ$ and $\theta_1=54^\circ$ would work.  It looks
useful to express the angle penalty in terms of the separatrix vectors
$\bfv$.  If $t=\tan(\theta_0)$, for either vector $\bvf$ we need to have
\begin{equation}
